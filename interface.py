...
st.title('Predicción de Valor de Propiedad')
st.write('Introduce los valores de las características y pulsa el '
...
habitaciones = st.number_input('Habitacions', value=0)
aseos = st.number_input('Lavabos', value=0)
...
metros = st.number_input('Metres', value=0)
...
if st.button('Mostrar Características'):
...
if st.button('Predecir'):
    ...
    input_data = pd.DataFrame([[caracteristicas, habitaciones, aseos, terraza,
                                piscina, garaje, metros, barri, pob_ocupada,
                                renta_mitjana, preuM2, preuTeoric]],
    ...
    st.write('El valor de la propiedad predicho es:', prediction)
